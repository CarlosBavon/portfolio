...
function Cardgrid () {
    return (
        <div class="card-grid">
            <div class="card intro" data-aos="fade-left"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine" data-aos-duration="1500">
            ...
            <div class="card tech" data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine" data-aos-duration="1500">
            ...
            <div class="card time" data-aos="fade-up"
     data-aos-duration="1500">
            ...
            <div class="card passion" data-aos="fade-up"
     data-aos-duration="1500">
